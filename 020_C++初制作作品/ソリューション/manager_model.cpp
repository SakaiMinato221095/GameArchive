...
HRESULT CManagerModel::Load(HWND hWnd)
{
	...
	{// 失敗時
	 ...
	 // 失敗メッセージ
		MessageBox(hWnd, "アイテムのデータ", "データ読み込み処理失敗！", MB_ICONWARNING);
	...
	// エフェクトオブジェクト
	if (FAILED(CEffectObject::Load()))
	{// 失敗時

	 // 失敗メッセージ
		MessageBox(hWnd, "エフェクトオブジェクトのデータ", "データ読み込み処理失敗！", MB_ICONWARNING);
	...
	{// 失敗時
		...
		// 失敗メッセージ
		MessageBox(hWnd, "ゴミ収集のデータ", "データ読み込み処理失敗！", MB_ICONWARNING);
	...
	// ゲート
	if (FAILED(CGate::Load()))
	{// 失敗時

		// 失敗メッセージ
		MessageBox(hWnd, "ゲートのデータ", "データ読み込み処理失敗！", MB_ICONWARNING);

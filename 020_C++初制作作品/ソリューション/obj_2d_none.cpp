...
const char *pTextureObj2dNone[] =
{
	...
	"data\\TEXTURE\\ElemWindow000.png",			// 属性枠のテクスチャ
...
//- 通常2Dオブジェクトの初期化処理
//-------------------------------------
HRESULT CObj2dNone::Init(TEX tex)
{
	// 使用テクスチャの設定
...
//-	通常2Dオブジェクトの生成処理
//-------------------------------------
CObj2dNone *CObj2dNone::Create(TEX tex)
{
	// 通常2Dオブジェクトの生成
	CObj2dNone *pNumber = DBG_NEW CObj2dNone(7);
...
//- 通常2Dオブジェクトの設定処理
//-------------------------------------
void CObj2dNone::Set(D3DXVECTOR3 pos ,D3DXVECTOR3 size , D3DXCOLOR color)
{
	m_dataPos.Set(pos);
	m_dataSize.Set(size);

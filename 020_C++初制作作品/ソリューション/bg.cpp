...
const char *pTextureBg[] =
{
	...
	"data\\TEXTURE\\result_win.png",	// 勝利のリザルトのテクスチャ
	"data\\TEXTURE\\result_end.png",	// 通常のリザルトのテクスチャ
	"data\\TEXTURE\\result_loose.png",	// 敗北のリザルトのテクスチャ
};
...
void CBg::SetVtx(void)
{
	...
	D3DXVECTOR2 texPos = m_dataTexPos.Get();	// テクスチャ位置
	D3DXVECTOR2 texMove = m_dataTexMove.Get();	// テクスチャ移動量
...
void CBg::AddTexPos(void)
{
	...
	// 情報更新
	m_dataTexPos.Set(texPos);		// テクスチャ位置
	m_dataTexMove.Set(texMove);		// テクスチャ移動量
}
